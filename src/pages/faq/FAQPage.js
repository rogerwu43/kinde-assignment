    ...
    return (
        <div className="faq-page pages-medium-page">
            ...
            <div className="pages-body-container">
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. In pulvinar congue odio sed mattis. Sed a tellus eget odio blandit varius id ac
                    augue. Etiam porta libero eu justo consectetur, eget sagittis est dictum. Integer fringilla purus eu bibendum consectetur. In cursus lectus
                    non neque bibendum aliquam. Etiam viverra lobortis posuere. Proin ultricies turpis non felis dignissim condimentum. Etiam tortor nunc,
                    vehicula vitae interdum sed, sagittis a enim. In id efficitur arcu. Vestibulum eget augue lobortis, fermentum sapien porttitor, facilisis ante.
                    Maecenas eget lectus purus. Cras dictum lacus vitae lacus tincidunt, non luctus lorem molestie. Sed sit amet justo volutpat, tempor massa
                ...
                <p>
                    ...
                    placerat tortor egestas ac. Donec sapien ipsum, lobortis eu orci vehicula, pellentesque vestibulum purus. In vitae ex quis orci varius
                ...
                <p>
                    ...
                    eleifend eros eros, eu imperdiet felis pulvinar ac. Curabitur eu purus leo. Suspendisse mauris mauris, volutpat nec ante viverra, pharetra
                ...
                <p>
                    ...
                    mauris. Sed finibus ut ipsum at ornare. Fusce ut lacus dapibus nisl ullamcorper tempor vel at orci. Maecenas at ante a massa vulputate
                    dignissim. Pellentesque metus libero, sodales eget vestibulum et, laoreet nec erat. Sed ac orci est. Vivamus tortor purus, feugiat ac nisl
                    eget, elementum rhoncus quam.
                </p>
            </div>
        </div>
    );
